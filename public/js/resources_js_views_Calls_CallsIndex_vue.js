...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    dateDiff: function dateDiff(startDateString, endDateString) {
      ...
      var duration = moment__WEBPACK_IMPORTED_MODULE_6___default().utc(moment__WEBPACK_IMPORTED_MODULE_6___default()(startDateString).diff(moment__WEBPACK_IMPORTED_MODULE_6___default()(endDateString))).format("HH:mm:ss"); // let days = duration.asDays();
